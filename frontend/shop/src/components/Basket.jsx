...
function Basket() {
  ...
  const handleOnChange = async (e, itemId) => {
    const newQuantity = parseInt(e.target.value);

    // 1. Aktualizacja lokalnego UI
    ...
    try {
      // 2. Aktualizacja w backendzie
      await axios.put(`${API_URL}/basket/updateQuantity`, {
        basketId: itemId,
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex items-center">
                  <img
                    src={`https://bxzunvkwuzfhymlloazq.supabase.co/storage/v1/object/public/products-images/${item.product?.imgSrc}?width=300&quality=60&format=webp`}
